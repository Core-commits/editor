...
namespace tridiModellerThingy
{
	...
	public partial class MainForm : Form
	{
		...
		string coderequied;
		string[] codestore = {"begin"};
		string[] codestore2 = {"begin"};
		...
		float[] specular = { 1.0f, 1.0f, 1.0f, 1.0f };
            	...
            	double tra_x=0.0,tra_y=0.0,tra_z=0.0;
            ...
            int test_rot = 0;
            	float[] brass_ambient =
{0.33f, 0.22f, 0.03f, 1.0f}, brass_diffuse =
{0.78f, 0.57f, 0.11f, 1.0f}, brass_specular =
{0.99f, 0.91f, 0.81f, 1.0f}; float brass_shininess = 27.8f;
 ...
 // GL.ClearColor(Color.Crimson);
   ...
   if (codestore[i].Contains("sphere")){
   	...
   	if (codestore[i].Contains("color")){
            			...
            			float[] color	   =  {Single.Parse(String.Format("0.{0}",codestore[i+1])), Single.Parse(String.Format("0.{0}",codestore[i+2])), Single.Parse(String.Format("0.{0}",codestore[i+3])), 1.0f};
            			//if (.Contains("red")){
